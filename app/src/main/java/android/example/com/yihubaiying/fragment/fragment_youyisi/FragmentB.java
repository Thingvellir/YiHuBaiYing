...
public class FragmentB extends BaseFragment {
    ...
    private void initDatas() {
        News news1=new News("这5种避孕套赶快扔掉 用了小心染上病","寻医问药网","21077看过 红包剩余69.2元",R.drawable.jiankang1);
        News news2=new News("乳腺癌早期症状有哪些？女性12个症状要警惕乳腺癌","人民网健康","59720看过 红包剩余35.8元",R.drawable.jiankang2);
        News news3=new News("女人每天最需要的5种食物，吃这些才健康","搜狐健康","54785看过 红包剩余39.1元",R.drawable.jiankang3);
        News news4=new News("什么样的痣会引发皮肤癌？留意7个恶变信号","新华网健康","17377看过 红包剩余47.7元",R.drawable.jiankang4);
        News news5=new News("男人吃太饱有什么危害，这几种食物千万不要再吃了","百度医生","40621看过 红包剩余11.2元",R.drawable.jiankang5);
