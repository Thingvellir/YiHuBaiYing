...
public class FragmentD extends BaseFragment {
    ...
    private void initDatas() {
        News news1=new News("央行拟颁布新规：进一步加强金融机构资管业务监管","易通贷","13469看过 红包剩余11.4元",R.drawable.caijing1);
        News news2=new News("解读：私募是否会哭晕？合格投资者门槛提至500万","东方财富","54881看过 红包剩余26.1元",R.drawable.caijing2);
        News news3=new News("上海房价纪录刷新:汤臣一品豪宅每平34万 总价2.05亿","新浪财经","76564看过 红包剩余116.1元",R.drawable.caijing3);
        News news4=new News("首次房地产违规跨省大检查启动 广告违规用词全抠掉","腾讯财经","44527看过 红包剩余11.0元",R.drawable.caijing4);
        News news5=new News("万达寻求以50亿美元一次性打包卖出五处海外资产","雪球财经","78527看过 红包剩余7.1元",R.drawable.caijing5);
